...
| --- | --- | --- |
| iPhone / iPad | `VampTerminal-iOS-2.0.0-build-23-altstore-unsigned.ipa` | Multi-tab terminal client |
...
| macOS | `VampHost-macOS-2.0.0-build-23-adhoc.zip` | Full Vamp Host: remote clients plus optional Terminal Mode |
| macOS | `VampTerminalHost-macOS-2.0.0-build-23-adhoc.zip` | Terminal-only host with Safari control and Tailscale |
...
1. Download the [latest Vamp Terminal IPA](https://github.com/Mesutcydev/macpair/releases/latest/download/VampTerminal-iOS-2.0.0-build-23-altstore-unsigned.ipa) and its `.sha256` file from the same release.
2. Verify the download:

   ```sh
   shasum -a 256 -c VampTerminal-iOS-2.0.0-build-23-altstore-unsigned.ipa.sha256
   ```
...
- [Vamp Host](https://github.com/Mesutcydev/macpair/releases/latest/download/VampHost-macOS-2.0.0-build-23-adhoc.zip) for remote display, remote input, remote clients, and optional Terminal Mode.
- [Vamp Terminal Host](https://github.com/Mesutcydev/macpair/releases/latest/download/VampTerminalHost-macOS-2.0.0-build-23-adhoc.zip) for terminal tabs, Safari control, pairing, and Tailscale only.
