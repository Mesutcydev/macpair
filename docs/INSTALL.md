...
This is the current install path for Vamp Terminal build 17. The project has
four separate install surfaces:

| Surface | Artifact | Use it for |
| --- | --- | --- |
| iPhone / iPad | `VampTerminal-iOS-1.0.0-build-17-altstore-unsigned.ipa` | Multi-tab terminal client |
...
| macOS | `VampHost-macOS-3.2.0-build-17-adhoc.zip` | Full Vamp Host: remote clients plus optional Terminal Mode |
| macOS | `VampTerminalHost-macOS-1.0.0-build-17-adhoc.zip` | Terminal-only host with Safari control and Tailscale |
| Linux | `linux-host/vamp_terminal_host.py` | Browser-only terminal host |

The current downloads are in the [build 17 GitHub release](https://github.com/Mesutcydev/macpair/releases/tag/vamp-terminal-1.0.0-build-17).

## 1. Install the iPhone or iPad client

1. Download the [Vamp Terminal IPA](https://github.com/Mesutcydev/macpair/releases/download/vamp-terminal-1.0.0-build-17/VampTerminal-iOS-1.0.0-build-17-altstore-unsigned.ipa) and its `.sha256` file.
2. Verify the download:

   ```sh
   shasum -a 256 -c VampTerminal-iOS-1.0.0-build-17-altstore-unsigned.ipa.sha256
   ```
...
The current Vamp Remote builds are attached to the [Vamp Terminal build 17 release](https://github.com/Mesutcydev/macpair/releases/tag/vamp-terminal-1.0.0-build-17):

- [iOS IPA](https://github.com/Mesutcydev/macpair/releases/download/vamp-terminal-1.0.0-build-17/VampRemote-iOS-3.7.2-build-36-altstore-unsigned.ipa) — unsigned; import with AltStore or another compatible sideloader.
- [iOS checksum](https://github.com/Mesutcydev/macpair/releases/download/vamp-terminal-1.0.0-build-17/VampRemote-iOS-3.7.2-build-36-altstore-unsigned.ipa.sha256)
- [macOS ZIP](https://github.com/Mesutcydev/macpair/releases/download/vamp-terminal-1.0.0-build-17/VampRemote-macOS-1.3.15-build-32-unsigned.zip) — unzip and move Vamp Remote to Applications.
- [macOS checksum](https://github.com/Mesutcydev/macpair/releases/download/vamp-terminal-1.0.0-build-17/VampRemote-macOS-1.3.15-build-32-unsigned.zip.sha256)

## 2. Install a macOS host

Download one of the ad-hoc signed ZIPs:

- [Vamp Host](https://github.com/Mesutcydev/macpair/releases/download/vamp-terminal-1.0.0-build-17/VampHost-macOS-3.2.0-build-17-adhoc.zip) for remote display, remote input, remote clients, and optional Terminal Mode.
- [Vamp Terminal Host](https://github.com/Mesutcydev/macpair/releases/download/vamp-terminal-1.0.0-build-17/VampTerminalHost-macOS-1.0.0-build-17-adhoc.zip) for terminal tabs, Safari control, pairing, and Tailscale only.
