...
This is the current install path for Vamp Suite 2.3.0 build 47. Downloads also
...
| --- | --- | --- |
| iPhone / iPad | `VampTerminal-iOS-2.3.0-build-47-altstore-unsigned.ipa` | Eight-tab terminal client and agent launchers |
| iPhone / iPad | `VampControl-iOS-2.3.0-build-47-altstore-unsigned.ipa` | Touch-first remote screen, Picture in Picture, remote Command-Tab, smoother zoom, and corrected SDR colors |
...
1. Download the [latest Vamp Terminal IPA](https://github.com/Mesutcydev/macpair/releases/latest/download/VampTerminal-iOS-2.3.0-build-47-altstore-unsigned.ipa) and its `.sha256` file from the same release.
2. Verify the download:

   ```sh
   shasum -a 256 -c VampTerminal-iOS-2.3.0-build-47-altstore-unsigned.ipa.sha256
   ```
...
- [iOS IPA](https://github.com/Mesutcydev/macpair/releases/latest/download/VampControl-iOS-2.3.0-build-47-altstore-unsigned.ipa) — unsigned; import with AltStore or another compatible sideloader.
- [iOS checksum](https://github.com/Mesutcydev/macpair/releases/latest/download/VampControl-iOS-2.3.0-build-47-altstore-unsigned.ipa.sha256)
- [macOS ZIP](https://github.com/Mesutcydev/macpair/releases/latest/download/VampControl-macOS-2.3.0-build-47-adhoc.zip) — unzip and move Vamp Control to Applications.
- [macOS checksum](https://github.com/Mesutcydev/macpair/releases/latest/download/VampControl-macOS-2.3.0-build-47-adhoc.zip.sha256)
...
1. Verify the download:
   ...
   ```sh
   shasum -a 256 -c VampHost-macOS-2.3.0-build-47-adhoc.zip.sha256
   ```
