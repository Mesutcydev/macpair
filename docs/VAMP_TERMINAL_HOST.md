...
[Download the latest Vamp Host](https://github.com/Mesutcydev/macpair/releases/download/vamp-terminal-1.0.0-build-5/VampHost-macOS-3.2.0-build-4-adhoc.zip) ·
[Download Vamp Terminal Host](https://github.com/Mesutcydev/macpair/releases/download/vamp-terminal-1.0.0-build-5/VampTerminalHost-macOS-1.0.0-build-3-adhoc.zip)
