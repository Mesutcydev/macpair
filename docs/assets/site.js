(() => {
  ...
  const translations = {
    tr: {
      ...
      'assistant.galleryKicker': 'Assistant’ın içinde', 'assistant.galleryTitle': 'Bağlamı koruyan araçlar.',
      'assistant.galleryLead': 'Sohbet, tarayıcı, simülatör, modeller, botlar ve uzak oturumlar tek bir yerel çalışma alanını paylaşır.',
      'assistant.simTitle': 'iOS uygulamalarını oluştur ve incele', 'assistant.simCopy': 'Aygıt başlat, derleme yükle, uygulamayı aç, ekran görüntüsü al ve görünen sonucu doğrula.',
      'assistant.browserToolTitle': 'Ajan kontrollü tarayıcı', 'assistant.browserToolCopy': 'Açık işlem onaylarıyla oku, gezin, tıkla, yaz ve doğrula.',
