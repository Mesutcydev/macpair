...
struct WelcomeStep: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 14) {
            PRScreenHeader(title: "welcome", host: "screenharbor.host", state: .live)
                ...
                VStack(spacing: 12) {
                    ...
                    PRCard("security model") {
                        VStack(alignment: .leading, spacing: 8) {
                            ...
                            secLine(icon: "person.badge.shield.checkmark.fill", text: "explicit approval — new ScreenHarbor clients must be accepted on-screen")
