...
struct BonjourWakeService {
    private static let logger = Logger(subsystem: "com.remotedesktop.client", category: "BonjourWake")
    private static let queue = DispatchQueue(label: "com.remotedesktop.client.bonjour-wake")
